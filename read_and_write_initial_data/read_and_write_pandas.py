...
directory = '/workspaces/Streaming-spark-kafka-elasticsearch-kibana-minio-docker/data/KETI'
dataframes = {}
dataframes_room = {}
...
def write_main_dataframe(df):
    ...
    """
    df.to_csv('/workspaces/Streaming-spark-kafka-elasticsearch-kibana-minio-docker/sensors.csv', index=False)
